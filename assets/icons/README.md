...
- Closed 2026-09-06: `launch` redrawn as a panel with its corner knocked out and the arrow leaving through the notch, chosen by Izzy from `explorations/launch.png`. The unioned panel it replaces stays in `shapes.js` as `launchSolid`, out of `SET`.
